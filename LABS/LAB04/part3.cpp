/************************************************
Text File Analyzer (word count, average word count, average sentence length, for as long as you want)
Gregory Mathias
************************************************/
...
int main() {
    ...
    goto RESTART; //When C/C++ is compiled to assembly, this is all that a loop really is. Bad practice, but fun for non-mission critical experiments.
}
